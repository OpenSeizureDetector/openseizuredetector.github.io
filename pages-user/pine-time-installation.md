...
|  3.3.1   | **Select PineTime (BLE2) Data Source** Open the menu (three dots in top right of screen) and select 'Settings', then 'General'.  Click on 'Select Data Source', and select 'PineTime (BLE2)'.    | [<img alt="DSC_0278" src="/assets/images/pinetime-installation-images/DSC_0278.JPG" width="100">](/assets/images/pinetime-installation-images/DSC_0278.JPG){:target="_blank"} | 
