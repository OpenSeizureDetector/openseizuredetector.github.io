# New (2024) OpenSeizureDetector Web Site

This repository contains the OpenSeizureDetector web site as it is migrated to a static (jekyll) based web site that can be hosted on Github pages rather than the original WordPress based site.

The site structure was initially based on the [Cayman Theme](https://github.com/pages-themes/cayman).

It will be deployed at [https://openseizuredetector.github.io](https://openseizuredetector.github.io).

## Previewing the site locally

If you'd like to preview the site locally (for example, in the process of proposing a change):

1. Clone down the theme's repository (`git clone https://github.com/openseizuredetector/openseizuredetector.github.io`)
